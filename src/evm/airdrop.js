...
// Airdrop a reward token to weighted allocations [{owner, amountRaw}]. Records
// every recipient (repo.addAirdrop) so partial failures are visible and
...
//     (disperseToken(token, recipients[], values[])); the token is auto-approved
//     to the disperse contract on first use. Fewest txs for large drops — this is
//     what makes a big airdrop go out fast.
...
//     estimateGas / fee / nonce round-trips.
...
// allowance is huge and this is a no-op.
